...
# changed : 2021-10-20 13:11:46 (Marcel Arpogaus)
# DESCRIPTION #################################################################
...
class MedianAbsoluteError(tf.keras.metrics.MeanAbsoluteError):
    def __init__(
        self, distribution_class, name="median_absolute_error", scale=1.0, **kwargs
    ):
